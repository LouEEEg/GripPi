...
void parseData(SerialInput GripPi_serial) {               // split the data into its parts
  ...
  strtokIndx = strtok(GripPi_serial.tempChars,",");       // get the first part - the string
  GripPi_serial.Rx_x = atof(strtokIndx);                  // copy it to messageFromPC

  strtokIndx = strtok(NULL, ",");                         // this continues where the previous call left off
  GripPi_serial.Rx_y = atof(strtokIndx);                  // convert this part to an integer
...
void printParsedData(SerialInput GripPi_serial) {
  Serial.print("X ");
  Serial.println(GripPi_serial.Rx_x);
  Serial.print("Y ");
  Serial.println(GripPi_serial.Rx_y);
  Serial.print("Z ");
  Serial.println(GripPi_serial.Rx_z);
}
